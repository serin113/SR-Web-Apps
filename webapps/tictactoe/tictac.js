...
{
winPoints++;
var i = parseInt(winPoints) + parseInt(win);
document.getElementById('win').value = i;
saveScoreAuto();
}
...
{
losePoints++;
var i = parseInt(losePoints) + parseInt(lose);
document.getElementById('lose').value = i;
saveScoreAuto();
}

function resetScore()
{
var i= confirm("Are you sure to reset your scores to zero?");
if (i==true)
{
...
winPoints=0;
losePoints=0;
alert("Scores successfully reset to zero.");
reset();
}
}
